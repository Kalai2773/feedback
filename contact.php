...
?>
       ...
       <div class="row">
			...
			<div class="col-md-4" style="margin-top:30px">
                ...
                <p>
					140, Teppakulam W St,<br>Kamarajar Salai,<br>Madurai, Tamil Nadu 625009,India<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">Phone</abbr>: 0452 231 1875</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">Email</abbr>: <a href="mailto:name@example.com">principaltcarts@gmail.com</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">Open Hours</abbr>: Monday - Saturday: 9:00 AM to 6:00 PM</p>
